...
public class User_Controls {
    ...
    public static void intro(){
        ...
        boolean stop = false;
        while (!stop){
            System.out.println("Do you want to buy, sell or exit? (Write 'buy', 'sell' or 'exit')");
    ...
    private static void selling_info(){
        ...
        String contact_num = get_input("What is your contact number?");
        String contact_email = get_input("What is your contact email?");
        ...
        sell_buy.create_post(name, description, price1, contact_num, contact_email, password);
    }
