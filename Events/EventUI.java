...
public class EventUI { //The user interface for the events section
    ...
    //Events.main.java.Events.EventManager Controller that controls how events work
    private EventManager em;

    /**
     * Constructor that initializes the Events.main.java.Events.EventUI object and its Events.main.java.Events.EventManager attribute.
     */
    public EventUI() {
        em = new EventManager();
    }
